...
################################################################################
#' @title regulonSelections
#' @description Regulon orders/selection for plots
#' @param binaryRegulonActivity binaryRegulonActivity
#' @param binaryRegulonActivity_nonDupl binaryRegulonActivity_nonDupl
#' @param minCells minCells
#' @param scenicOptions scenicOptions
#' @export
regulonSelections <- function(scenicOptions, binaryRegulonActivity, binaryRegulonActivity_nonDupl, minCells)
{
