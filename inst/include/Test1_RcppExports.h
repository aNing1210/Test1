...
#ifndef RCPP_Test1_RCPPEXPORTS_H_GEN_
#define RCPP_Test1_RCPPEXPORTS_H_GEN_
...
namespace Test1 {
    ...
    namespace {
        void validateSignature(const char* sig) {
            ...
            require("Test1", Rcpp::Named("quietly") = true);
            typedef int(*Ptr_validate)(const char*);
            static Ptr_validate p_validate = (Ptr_validate)
                R_GetCCallable("Test1", "_Test1_RcppExport_validate");
            if (!p_validate(sig)) {
                throw Rcpp::function_not_exported(
                    "C++ function with signature '" + std::string(sig) + "' not found in Test1");
            }
        }
    }
    ...
    inline NumericMatrix kde_cpp(NumericMatrix data, int k = 1, int b = 1, int pdf = 1, int density_sample_type = 1) {
        ...
        if (p_kde_cpp == NULL) {
            ...
            p_kde_cpp = (Ptr_kde_cpp)R_GetCCallable("Test1", "_Test1_kde_cpp");
        }
    ...
    inline NumericMatrix kde(SEXP data, SEXP k, SEXP b, SEXP pdf, SEXP density_sample_type) {
        ...
        if (p_kde == NULL) {
            ...
            p_kde = (Ptr_kde)R_GetCCallable("Test1", "_Test1_kde");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline List knn_density(SEXP x, SEXP y, SEXP k) {
        ...
        if (p_knn_density == NULL) {
            ...
            p_knn_density = (Ptr_knn_density)R_GetCCallable("Test1", "_Test1_knn_density");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline NumericMatrix knn_density_2d(SEXP x, SEXP y, SEXP nGrids, SEXP k) {
        ...
        if (p_knn_density_2d == NULL) {
            ...
            p_knn_density_2d = (Ptr_knn_density_2d)R_GetCCallable("Test1", "_Test1_knn_density_2d");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline double digamma_0(double x) {
        ...
        if (p_digamma_0 == NULL) {
            ...
            p_digamma_0 = (Ptr_digamma_0)R_GetCCallable("Test1", "_Test1_digamma_0");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline double vd(SEXP d) {
        ...
        if (p_vd == NULL) {
            ...
            p_vd = (Ptr_vd)R_GetCCallable("Test1", "_Test1_vd");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline double entropy(SEXP x, SEXP k) {
        ...
        if (p_entropy == NULL) {
            ...
            p_entropy = (Ptr_entropy)R_GetCCallable("Test1", "_Test1_entropy");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline double mi(SEXP x, SEXP y, SEXP k, SEXP normalize) {
        ...
        if (p_mi == NULL) {
            ...
            p_mi = (Ptr_mi)R_GetCCallable("Test1", "_Test1_mi");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline List cmi(SEXP x, SEXP y, SEXP z, SEXP k, SEXP normalize) {
        ...
        if (p_cmi == NULL) {
            ...
            p_cmi = (Ptr_cmi)R_GetCCallable("Test1", "_Test1_cmi");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline List ucmi_cpp(const NumericMatrix& x, const NumericMatrix& y, NumericMatrix z, int k, int method, int k_density, double bw) {
        ...
        if (p_ucmi_cpp == NULL) {
            ...
            p_ucmi_cpp = (Ptr_ucmi_cpp)R_GetCCallable("Test1", "_Test1_ucmi_cpp");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline List ucmi(SEXP x, SEXP y, SEXP z, SEXP k, SEXP method, SEXP k_density, SEXP bw) {
        ...
        if (p_ucmi == NULL) {
            ...
            p_ucmi = (Ptr_ucmi)R_GetCCallable("Test1", "_Test1_ucmi");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline double umi_cpp(const NumericMatrix& x, const NumericMatrix& y, int k, int method, int k_density, double bw) {
        ...
        if (p_umi_cpp == NULL) {
            ...
            p_umi_cpp = (Ptr_umi_cpp)R_GetCCallable("Test1", "_Test1_umi_cpp");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline double umi(SEXP x, SEXP y, SEXP k, SEXP method, SEXP k_density, SEXP bw) {
        ...
        if (p_umi == NULL) {
            ...
            p_umi = (Ptr_umi)R_GetCCallable("Test1", "_Test1_umi");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
...
#endif // RCPP_Test1_RCPPEXPORTS_H_GEN_
